...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <ul class="nav menu">
            ...
            <li class="active" style="border-top: #0088cc solid 1px"><a href="controller?action=getadmins"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> ${manager.getString("main-page-nav-link4")}</a></li>
        </ul>
    </div>
                                ...
                                <table class="table table-striped" data-toggle="table"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                    ...
                                    <c:forEach var="admin" items="${admins}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="controller?action=deleteadmin&id=${admin.getId()}"><span title="${manager.getString("admins-page-table-span")}" style="font-size:19px;padding-left: 7px; color:red" class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="controller">
                  ...
                  <div class="form-group">
                    <label for="lastname">${manager.getString("modal-new-admin-label3")} </label>
